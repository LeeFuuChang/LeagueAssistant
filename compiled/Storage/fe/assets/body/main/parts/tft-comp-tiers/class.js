            ...
            $.get(`/opgg/tft/meta-trends/comps?mode=RANKED_TFT&tier=${rankTier}`, {}, (pageProps)=>{
                ...
                let displayDeck = (ele, deckIndex)=>{
                    return new Promise((resolve, reject)=>{
                        ...
                        if(deckIndex+1 >= sorted.length) return;
                        displayDeck(this.CreateInnerItem(container).hide(0), deckIndex+1);
                    });
                };
                displayDeck(this.CreateInnerItem(container), 0);
            });
        });
    }
}